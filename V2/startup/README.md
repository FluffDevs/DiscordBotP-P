...
PowerShell (depuis la racine du projet V2) :
...
- Option 1 (nssm, recommandé pour simplicité) :
  ...
  2. Créer un service :
     nssm install MyDiscordBotV2 "C:\\Program Files\\nodejs\\node.exe" "C:\\path\\to\\project\\V2\\startup\\start-and-monitor.js"
  3. Configurer "Start Directory" sur le répertoire racine du projet V2.
...
- Le script gère des redémarrages automatiques avec backoff exponentiel (configurable via variables d'environnement, voir ci-dessous).
